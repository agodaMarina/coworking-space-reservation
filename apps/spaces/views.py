...
class SpaceListView(generics.ListAPIView):
    ...
    @extend_schema(
        summary="Liste de tous les espaces",
        tags=['Espaces']
    )
...
class SpaceUpdateView(generics.UpdateAPIView):
    ...
    @extend_schema(
        summary="Modifier partiellement un espace",
        tags=['Espaces']
    )
...
class SpaceAvailabilityGetView(APIView):
    ...
    @extend_schema(
        ...
        tags=['Espaces'],
        parameters=[
            OpenApiParameter('start_datetime', str, description='Date début (ISO 8601)'),
...
class SpacePhotoDeleteView(generics.DestroyAPIView):
    ...
    @extend_schema(
        summary="Supprimer une photo d'espace",
        tags=['Espaces']  
    )
    def delete(self, request, *args, **kwargs):
