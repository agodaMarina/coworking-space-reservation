...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',  # <--- AJOUTEZ CETTE LIGNE ICI
...
# OBLIGATOIRE avant la 1ère migration
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': "API REST du système de réservation d'espaces de coworking",
    'VERSION': '1.0.0',
